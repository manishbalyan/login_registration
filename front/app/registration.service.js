...
var mock_registration_1 = require("./mock-registration");
...
var RegistrationService = (function () {
    ...
    RegistrationService.prototype.getUser = function () {
        return Promise.resolve(mock_registration_1.USER);
    };
    RegistrationService.prototype.insertUser = function (user) {
        ...
        return this._http.post('http://127.0.0.1:8000/user/', user).map(function (res) {
        });
    };
